...
> - **[Performance - 2026-03-29] Batch Review Session Update:** Tối ưu hóa hiệu năng phiên học bằng cách loại bỏ gọi lệnh API lưu vào DB đơn lẻ cho từng thẻ. Tích hợp hàng đợi xử lý Memory và **Màn hình Tổng kết (Review Summary)** ở cuối phiên. Người dùng có thể kiểm tra lại toàn bộ từ vựng & ngữ pháp cùng mức điểm đánh giá (Dễ, Vừa, Khó) vừa học trước khi nhấn nút "Xác nhận & Hoàn tất" để lưu đồng loạt (Batch Update) trong một transaction duy nhất, giảm triệt để tình trạng nghẽn/lag mạng.
T h � m   g i �i   h �n 
 
